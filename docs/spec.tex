...
The remainder of this paper is organized as follows. Section~\ref{sec:related} surveys related work. Sections~\ref{sec:foundations}--\ref{sec:ablation} present the complete technical framework. Section~\ref{sec:experiments} is reserved for empirical validation. Section~\ref{sec:limitations} discusses limitations, and Section~\ref{sec:conclusion} concludes. Architecture-specific implementations and a complete notation reference appear in the appendices.
