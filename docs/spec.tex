...
\label{rem:multiple-neutral-baselines}
...
\end{itemize}
If training ends before $K$ subsequent evaluations are available, the final checkpoint is accepted as the peak if it is the running maximum. This ensures peak selection always produces a result, though peaks confirmed only at end-of-training carry less stability evidence than those confirmed mid-training.
\end{remark}
